...
if case == 1:
    with cbook.get_sample_data('/home/amygdala/OXhack18/Hack-Oxford/Web/Images/academic_brain.png') as file:
        image = plt.imread(file)
    suggestions = ['Congratulations!',  'You are on track.', 'Stay curious and try our StudyBuddy feature.']
elif case==2:
    with cbook.get_sample_data('/home/amygdala/OXhack18/Hack-Oxford/Web/Images/slacking_brain.png') as file:
        image = plt.imread(file)
    ...
    with cbook.get_sample_data('/home/amygdala/OXhack18/Hack-Oxford/Web/Images/anxious_tired_brain.png') as file:
        image = plt.imread(file)
...
for iternum in [0,1,2]:
    title = plt.text(0.5,1.01,suggestions[iternum], ha="center",va="bottom",color=np.random.rand(3), transform=ax.transAxes, fontsize=16)
